...
class LoginScreen extends BaseUserEntryScreen {
  @override
    ...
    StreamBuilder<String> mobileNo = StreamBuilder<String>(
        ...
        builder: (context, snapshot) {
          return new EditField(
            StringConstants.LABEL_EDIT_FIELD_MOBILE_NO,
            StringConstants.HINT_EDIT_FIELD_MOBILE_NO,
  ...
  List<Label> getLabelList() {
    ...
    Label l1 = new Label(
        label: StringConstants.LABEL_ACCOUNT,
    ...
    Label l3 = new Label(
        label: StringConstants.CAPTION_LOGIN,
        labelComponentType: LabelComponentType.WIDGET,
        textStyle: style2);
    labelList.add(l3);
    return labelList;
